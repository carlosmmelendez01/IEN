        ...
        <div className="container relative z-20 mx-auto px-4 text-center">
          ...
          >
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                <Link href="/start-a-program">JOIN IHSEN</Link>
              </Button>
              <Button
                asChild
                variant="outline"
              ...
              >
                <a href="/schedule#high-school-schedules">VIEW SCHEDULE</a>
              </Button>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.75fr_1.25fr] gap-6 max-w-6xl mx-auto items-center">
            <div>
              ...
              <h2 className="text-2xl md:text-4xl font-heading font-bold text-white">
                High school coaches usually need these first.
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                ...
                <span className="mt-1 block text-xs text-muted-foreground leading-relaxed">
                  Start or renew your school program.
                </span>
              </Link>
              <a
                href="/schedule#high-school-schedules"
                className="bg-card border border-primary/25 rounded-lg p-5 hover:border-primary transition-colors"
              >
                ...
                <span className="mt-1 block text-xs text-muted-foreground leading-relaxed">
                  See preseason, regular season, playoffs, and finals.
                </span>
              </a>
              <Link
                href="/rules-policies"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-background border-2 border-primary p-8 rounded-xl shadow-[0_0_20px_rgba(212,175,55,0.1)]">
              <h3 className="font-heading font-bold text-2xl text-primary mb-4">Varsity — Divisions 1A &amp; 2A</h3>
              <p className="text-muted-foreground text-sm mb-4 leading-relaxed">
                The school's top team in each title. Varsity teams compete for playoff seeding and earn the right to attend the IEN State Finals in person. Each title is split into two divisions — <strong className="text-white">1A</strong> and <strong className="text-white">2A</strong> — to keep competition balanced. Smaller-enrollment schools generally play in 1A and larger schools in 2A, with the dividing line adjusted each season per title based on registrations.
              </p>
              <ul className="space-y-2 text-sm text-muted-foreground mb-6">
                <li className="flex gap-2"><span className="text-primary">✓</span> Eligible for playoffs and State Finals</li>
                <li className="flex gap-2"><span className="text-primary">✓</span> Placed in Division 1A or 2A per title based on enrollment and balance</li>
